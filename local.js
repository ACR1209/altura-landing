...
function changeStylesForLocale(locale) {
    ...
    if (locale === "es") {
        contactTitle.classList.remove("lg:text-8xl", "text-6xl");
        contactTitle.classList.add("lg:text-6xl","text-5xl");
    }

    if (locale === "en") {
        contactTitle.classList.remove("lg:text-6xl", "text-5xl");
        contactTitle.classList.add("lg:text-8xl", "text-6xl");
    }
}
